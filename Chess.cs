...
namespace Honorbuddy.Quest_Behaviors.Chess
{
    [CustomBehaviorFileName(@"Chess")]
    public class Chess : CustomForcedBehavior
    {
        public enum QBType
        {
            Current = 0,
        ...
        public Chess(Dictionary<string, string> args)
            : base(args)
        {
                    ...
                    new Decorator(
                        ...
                        new PrioritySelector(
                            new Decorator(
                                ...
                                new Sequence(
                                    new Action(ret => TreeRoot.StatusText = "Using Ability On Location: " + UseObject.Name + " " + Counter + " Out of " + NumOfTimes + " Times"),
